// frontend/src/types.ts (นี่คือไฟล์ที่จะถูกใช้ใน Frontend เท่านั้น)
...
export enum ServerMessageType {
    ...
    LOBBY_GAME_LIST_UPDATE = 'LOBBY_GAME_LIST_UPDATE', // New type for initial lobby list
...
export interface LobbyGameListUpdateMessage {
    type: ServerMessageType.LOBBY_GAME_LIST_UPDATE; // Use the new type
    payload: GameState[]; // This is now explicitly an array
}
